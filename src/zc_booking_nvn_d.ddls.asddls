...
define view entity ZC_BOOKING_NVN_D as projection on ZI_BOOKING_NVN_D
{
    key BookingUUID,
...
//        ]
     @Consumption.valueHelpDefinition: [ {entity: {name: '/DMO/I_Flight', element: 'ConnectionID'},
      ...
      /* Associations */
      _BookingSupplement : redirected to composition child ZC_SUPPLEMET_NVN_D,
      _BookingStatus,
      _Carrier,
      _Connection,
      _Customer,
      _Travel            : redirected to parent ZC_TRAVEL_NVN_D
}
